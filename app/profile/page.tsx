...
const user = {
  ...
  status: "Online",
  statusMessage: "\"Learning to find peace in the small moments. Some days are harder than others, but I&apos;m getting there.\"",
  posts: 128,
  likes: "4.2k",
  joinDate: "March 2024",
  stats: {
              ...
              <div className="terminal-window mb-4">
                <div className="p-6">
                  ...
                  <div className="text-center mb-6">
                    <h1 className="font-heading text-2xl text-foreground mb-1">{user.name}</h1>
                  ...
                  {/* Edit Profile Button */}
                  <Link href="/profile/edit" className="retro-btn-outline w-full px-4 py-3 text-xs tracking-widest flex items-center justify-center gap-2">
                ...
                <div className="p-4">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs text-primary">{user.stats.daysActive}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-muted-foreground">Posts This Month</span>
                      <span className="text-xs text-foreground">{user.stats.postsThisMonth}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-muted-foreground">Helpful Replies</span>
                      <span className="text-xs text-foreground">{user.stats.helpfulReplies}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-muted-foreground">Member Since</span>
                      <span className="text-xs text-foreground">{user.joinDate}</span>
                    </div>
                  </div>
                </div>
              </div>
